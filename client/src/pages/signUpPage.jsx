...
import { Box, Center, Button, Text, Flex, Input, InputGroup, FormLabel, InputRightElement, Image, IconButton } from '@chakra-ui/react'
        ...
        <>
            <Box pos="absolute" p="15px">
                ...
                <Button w="100%" bgColor={"white"}>
                    ...
                    <Text ml="5px" fontWeight="bold" fontSize="20px">Prelaunch.com</Text>
                    </Flex>
                </Button>
                </ChakraLink>
            </Box>
            <Center h="100vh">
                <Box p="5" w="440px" maxW="440px" textAlign="center">
                    ...
                    <Text color="gray.500" className="subTitle">Create your account</Text>
                        ...
                        <Flex direction="column">
                            ...
                            <InputGroup>
                                ...
                                <InputRightElement>
                                    ...
                                    icon={doShowPassword == "hide" ? <ViewOffIcon/> : <ViewIcon/>}
                                    />
                                </InputRightElement>
                            </InputGroup>
                            <Text color="red.300">{errors.password?.message}</Text>
                            <Input mt="20px" type="submit" color="white" w="100%" colorScheme="teal" bgColor="teal.300" value="Sign-up"/>
                        </Flex>
                    </form>
